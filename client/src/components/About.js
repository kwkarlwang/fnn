    ...
    <div style={{}} className="container">
      ...
      <div className="section">
        ...
        <p>
          ...
          News reporter or author is biased in their report. I chose Fox News
          and CNN not only because they are some of the most well known News
          outlets, but also because CNN leans toward the left wing and Fox News
          leans toward the right wing according to this{" "}
